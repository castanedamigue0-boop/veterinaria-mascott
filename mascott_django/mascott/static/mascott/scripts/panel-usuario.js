import { obtenerUsuario, actualizarUsuario, getSession, clearSession, obtenerTodosUsuarios } from './base-de-datos.js';

// ===== SESION =====
const session = getSession();
if (!session) { window.location.href = 'login-registro.html'; }

let userData = null;

async function cargarUsuario() {
  userData = await obtenerUsuario(session.email);
  if (!userData) { window.location.href = 'login-registro.html'; return; }
...
// ===== LOGOUT =====
function logout() { clearSession(); window.location.href = 'inicio.html'; }
