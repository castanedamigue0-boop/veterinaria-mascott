...
// Botón Admin → ir directo a panel-administrador.html
document.getElementById('btnAdmin')?.addEventListener('click', () => {
  window.location.href = '../paginas/panel-administrador.html';
});

// Login y registro → redirigir a login-registro.html
...
document.getElementById('linkRegister')?.addEventListener('click', (e) => {
  e.preventDefault();
  window.location.href = 'login-registro.html?tab=register';
});
...
(function() {
  ...
  ['btnLogin', 'btnLoginTop'].forEach(id => {
    ...
    btn.onclick = () => { window.location.href = '../paginas/panel-usuario.html'; };
  });
})();
