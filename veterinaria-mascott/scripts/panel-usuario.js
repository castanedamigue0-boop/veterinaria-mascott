...
if (!session) { window.location.href = '../paginas/login-registro.html'; }

let userData = null;

async function cargarUsuario() {
  userData = await obtenerUsuario(session.email);
  if (!userData) { window.location.href = '../paginas/login-registro.html'; return; }
...
// ===== LOGOUT =====
function logout() { clearSession(); window.location.href = '../paginas/inicio.html'; }
